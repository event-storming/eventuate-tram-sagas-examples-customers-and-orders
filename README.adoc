...
docker exec -it eventuate-tram-sagas-examples-customers-and-orders-mysql-1 /bin/bash
mysql --user=root --password=$MYSQL_ROOT_PASSWORD
use eventuate

docker exec -it eventuate-tram-sagas-examples-customers-and-orders-kafka-1 /bin/bash
